...
public class TTMuon {
    ...
    public TTMuon(String idMuon, LBCard TheMuon, Calendar NgayMuon, Calendar HanMuon, BookItem SachMuon,
            boolean TrangThai) {
        this.idMuon = idMuon;
    ...
    public String toString() {
        return String.format("%5s%15s%15s%15s%8s%35s%18s", idMuon, TheMuon.nguoiMuon.getName(),
                QLTV.toStringNgay(NgayMuon), QLTV.toStringNgay(HanMuon), SachMuon.idBIteam, SachMuon.Book.name,
                (TrangThai) ? "Đang được mượn" : "Đã trả");
    }
    ...
    public static TTMuon[] NhapGhiDL(boolean a, TTMuon DSM[]) {
        ...
        if (a) {
            ...
            try {
                FileWriter fw = new FileWriter("./data/BookItem.txt");
